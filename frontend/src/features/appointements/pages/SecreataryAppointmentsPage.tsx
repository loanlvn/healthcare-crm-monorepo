      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold">Agenda de la clinique</h1>
              <p className="text-muted text-sm">Interface secrétaire</p>
            </div>
          </div>
        </motion.header>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {!showAppointments && !showCreateForm && (
              <motion.section initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="card p-10 text-center">
...
function SecretaryCreateAppointmentForm({
  ...
  const valid = !!doctorId && !!patientId && !!startsAt && !!endsAt && new Date(startsAt) < new Date(endsAt);
  ...
  return (
    ...
    >
      ...
      <div className="md:col-span-2">
        ...
        <PatientPicker value={patientId} onChange={(id) => setPatientId(id || "")} ownerId={doctorId || undefined} required />
      </div>
